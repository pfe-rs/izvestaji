...
$$\frac{\delta}{\delta w_k}\left(1-y_i\left\langle x_i, w\right\rangle\right){+}=\begin{cases}0, &\text{if }y_i\left\langle x_i, w\right\rangle\geq1 \\ y_ix{i k},&\text{else}\end{cases}$$
