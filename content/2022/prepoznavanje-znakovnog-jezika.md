...
{{< figure "Slika" "Prikaz slova američkog znakovnog jezika (ASL)." >}}

![Prikaz slova američkog znakovnog jezika tako da uz svako slovo engleskog alfabeta stoji ruka ili pokret koji označavaju to slovo.](/images/2022/prepoznavanje-znakovnog-jezika/asl.png)
...
{{< figure "Slika" "Augmentirane slike iz baze." >}}

![5 puta 5 tabela sa augmentovanim slikama iz baze.](/images/2022/prepoznavanje-znakovnog-jezika/data-augmentation.png)

{{</ figure >}}

#### Obrada baze za kNN

Klasifikacija znaka koji je pokazan je realizovan prvo kroz određivanje pozicije šake. Za olakšanje ovog procesa pronađene su 21 ključne tačke šake (ukupno 42 koordinate) pomoću *MediaPipe Holistic Pipeline*-a [^5].

{{< figure "Slika" "Prikazane ključne tačke iz *MediaPipe Holistic Pipeline*." >}}
...
Binarizovana slika je podeljena na $N \times N$ mrežu, gde definišemo obeležje ($o$) svakog polja kao zasićenost - udeo belih piksela unutar tog polja:
...
{{< figure "Slika" "Dijagram funkcionisanja metode korišćenjem k Nearest Neighbours (kNN)." >}}
...
{{< figure "Slika" "Mapa intenziteta preciznosti kNN metode." >}}
...
{{< figure "Slika" "Preciznost i greška na trening i validacionim skupovima metode sa klasifikacijom ključnih tačaka." >}}
...
{{< figure "Slika" "Matrica konfuzije koja prikazuje koja slova se najčešće mešaju sa kojim drugim slovima prilikom primene metode klasifikacije ključnih tačaka." >}}
...
{{< figure "Slika" "Preciznost i greška na trening i validacionim skupovima CNN metode." >}}
...
{{</ figure >}}
{{< figure "Slika" "Matrica konfuzije koja prikazuje koja slova se najčešće mešaju sa kojim drugim slovima prilikom primene CNN metode." >}}
...
[^4]: [Synthetic ASL Alphabet](https://kaggle.com/datasets/lexset/synthetic-asl-alphabet)
