...
summary: Prepoznavanje znakovnog jezika je projekat rađen na letnjem kampu za stare polaznike 2022. godine od strane Zlate Stefanović i Vladana Bašića.
# TODO:
# image:
# imageAlt:
---
...
{{< figure "Slika" "Augmentovane slike iz baze." >}}
...
{{< figure "Slika" "Matrica konfuzije koja prikazuje koja se slova sa kojim drugim slovima najčešće mešaju prilikom primene metode klasifikacije ključnih tačaka." >}}
